...
seg.reg.table.df %>%
  ...
  row_spec(c(1:7, 10:11, 13:18, 22), background = "#FFF9A6", bold = T) %>% 
  row_spec(c(8, 9, 19:21, 23), background = "#FCC981", bold = T) %>% 
  row_spec(c(12, 24), background = "#D3D3D3", bold = T) %>%
  save_kable(here('figures', 'LFM.segreg.summary.html'))
```
...
seg.reg.table2.df %>% 
  ...
  kable_styling(bootstrap_options = c('hover', 'bordered', 'condensed'), fixed_thead = T) %>% 
  row_spec(c(1:3, 5, 10, 16, 18), background = "#FFF9A6", bold = T) %>% 
  row_spec(c(4, 6:9, 11, 13:15, 17, 19:23), background = "#FCC981", bold = T) %>% 
  row_spec(c(12, 24), background = "#D3D3D3", bold = T) %>%
  save_kable(here('figures', 'mpa.segreg.summary.html'))
```
