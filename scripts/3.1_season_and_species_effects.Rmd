...
pc1.vs.mpa.adfa <- precip_groups_ranis.adfa  %>%
  ...
  geom_abline(slope = -0.138, intercept = 0.128,
              color = '#c1121f', cex = 1, alpha = .9,
              show.legend = FALSE) +
  geom_abline(slope = -0.138, intercept = 0.954,
...
pc1.vs.mpa.ceme <- precip_groups_ranis.ceme  %>%
  ggplot(aes(y = r1_1, 
             ...
             group = season)) +
  geom_point(alpha = .65, aes(color = season), size = 2) +
  geom_abline(slope = -0.147, intercept = -0.842,
              color = '#c1121f', cex = 1, alpha = .9,
              show.legend = FALSE) +
  geom_abline(slope = -0.147, intercept = -0.520,
              color = '#669bbc', cex = 1, alpha = .9,
              show.legend = FALSE) +
  geom_segment(aes(x = -9.5, xend = -9.5, y = -5, yend = -3.4), arrow = arrow(length = unit(0.15, 'inches')), color = 'black') + # CHANGE TO x = 9 if text above!
...
pc2.vs.mpa.adfa <- precip_groups_ranis.adfa  %>%
  ggplot(aes(y = r1_2, 
             ...
             group = season)) +
  geom_point(alpha = .65, aes(color = season), size = 2) +
  geom_abline(slope = 0.109, intercept = 0.615,
              color = '#c1121f', cex = 1, alpha = 0.9,
              show.legend = FALSE) +
  geom_abline(slope = 0.109, intercept = 1.300,
...
pc2.vs.mpa.ceme <- precip_groups_ranis.ceme  %>%
  ggplot(aes(y = r1_2, 
             ...
             group = season)) +
  geom_point(alpha = .65, aes(color = season), size = 2) +
  geom_abline(slope = 0.121, intercept = 0.401,
              color = '#c1121f', cex = 1, alpha = 0.9,
              show.legend = FALSE) +
  geom_abline(slope = 0.121, intercept = 1.142,
              color = '#669bbc', cex = 1, alpha = 0.9,
              show.legend = FALSE) +
  geom_segment(aes(x = -9.5, xend = -9.5, y = -5, yend = -3.3), arrow = arrow(length = unit(0.15, 'inches')), color = 'black') +
  annotate('text', x = -8, y = -4.2, label = 'Less \n Consumable', fontface = 2) +
...
mpa.vs.lfm.adfa <- mpa_rel_df %>% 
  ...
  ggplot(aes(y = r1_lfm, 
             ...
             group = season)) +
  geom_point(alpha = .65, aes(color = season), size = 2) +
  geom_abline(slope = 0.039, intercept = 0.040,
              color = '#c1121f', cex = 1, alpha = 0.9,
              show.legend = FALSE) +
  geom_abline(slope = 0.039, intercept = 0.299,
              color = '#669bbc', cex = 1, alpha = 0.9,
              show.legend = FALSE) +
  labs(x = "Water Potential (MPa)", 
  ...
  guides(color = guide_legend(override.aes = list(size = 3))) +
  annotate('text', x = -9.7, y = 0.5, label = 'e', size = 12, face = 'bold') +
  scale_fill_manual(values=c("#c1121f","#669BBC"))
mpa.vs.lfm.adfa
```
...
mpa.vs.lfm.ceme <- mpa_rel_df %>% 
  ...
  ggplot(aes(y = r1_lfm, 
             ...
             group = season)) +
  geom_point(alpha = .65, aes(color = season), size = 2) +
  geom_abline(slope = 0.032, intercept = 0.002,
              color = '#c1121f', cex = 1, alpha = 0.9,
              show.legend = FALSE) +
  geom_abline(slope = 0.032, intercept = 0.409,
              color = '#669bbc', cex = 1, alpha = 0.9,
              show.legend = FALSE) +
  labs(x = "Water Potential (MPa)", 
       y = "Live Fuel Moisture (Scaled, Effects Removed)", 
  ...
  guides(color = guide_legend(override.aes = list(size = 3))) +
  annotate('text', x = -9.7, y = 0.37, label = 'f', size = 12, face = 'bold') +
  scale_fill_manual(values=c("#c1121f","#669BBC"))
mpa.vs.lfm.ceme
```
...
ggsave(here("figures", "main-figures", "Figure3.Season.Plot.jpg"),
...
pc1.vs.lfm.adfa <- szn_lfm_ranis  %>%
  ...
  ggplot(aes(y = r1_L, 
             ...
             group = season)) +
  geom_point(alpha = .65, aes(color = season), size = 2) +
  geom_abline(slope = -0.011, intercept = -0.063,
              color = '#c1121f', cex = 1, alpha = .9,
              show.legend = FALSE) +
  geom_abline(slope = -0.011, intercept = 0.703,
              color = '#669bbc', cex = 1, alpha = .9,
              show.legend = FALSE) +
...
pc1.vs.lfm.ceme <- szn_lfm_ranis  %>%
  ...
  ggplot(aes(y = r1_L, 
             ...
             group = season)) +
  geom_point(alpha = .65, aes(color = season), size = 2) +
  geom_abline(slope = -0.012, intercept = 0.038,
              color = '#c1121f', cex = 1, alpha = .9,
              show.legend = FALSE) +
  geom_abline(slope = -0.012, intercept = 0.878,
              color = '#669bbc', cex = 1, alpha = .9,
              show.legend = FALSE) +
...
pc2.vs.lfm.adfa <- szn_lfm_ranis  %>%
  ...
  ggplot(aes(y = r2_L, 
             ...
             group = season)) +
  geom_point(alpha = .65, aes(color = season), size = 2) +
  geom_abline(slope = 0.016, intercept = -0.590,
              color = '#c1121f', cex = 1, alpha = 0.9,
              show.legend = FALSE) +
  geom_abline(slope = 0.016, intercept = 0.377,
              color = '#669bbc', cex = 1, alpha = 0.9,
              show.legend = FALSE) +
...
pc2.vs.lfm.ceme <- szn_lfm_ranis  %>%
  ...
  ggplot(aes(y = r2_L, 
             ...
             group = season)) +
  geom_point(alpha = .65, aes(color = season), size = 2) +
  geom_abline(slope = 0.008, intercept = 0.206,
              color = '#c1121f', cex = 1, alpha = 0.9,
              show.legend = FALSE) +
  geom_abline(slope = 0.008, intercept = 0.773,
              color = '#669bbc', cex = 1, alpha = 0.9,
              show.legend = FALSE) +
...
pc1.mpa.spp <- ggplot(data= pc1_remef_year_df, aes(mpa.unscaled, pc1_remef_year, color = Species,shape = Species)) + 
  ...
  geom_abline(slope = -0.113, intercept = -0.934, color = "#9D0208", cex = 1, alpha = 0.9) +
  geom_abline(slope = -0.113, intercept = -1.738, color = "#F48C06", cex = 1, alpha = 0.9) +
  labs(x="Water Potential (-Mpa)", y="Ignitability-Combustibility Proxy") +
  annotate('point', x = -5.411, y = -0.322557, color = "#9D0208", size = 5, alpha = 0.9) +
  annotate('point', x = -7.444, y = -0.896828, color = "#F48C06", size = 5, alpha = 0.9) +
  ...
  annotate('text', x = -9.7, y = 3.6, label = 'a', size = 12) +
  th +
  th_panels +
...
tti.mpa.spp <- ggplot(data= tti_groups_ranis, aes(mpa.unscaled, r1_1, color = Species, shape = Species)) + 
  geom_point(size = 2, alpha = .65) + 
  geom_abline(slope = 1.423, intercept = 47.891, color = "#9D0208", cex = 1, alpha = 0.9) +
  geom_abline(slope = 1.423, intercept = 55.367, color = "#F48C06", cex = 1, alpha = 0.9) +
  annotate('point', x = -5.411, y = 40.19115, color = "#9D0208", size = 5, alpha = 0.9) +
  annotate('point', x = -7.444, y = 44.77419, color = "#F48C06", size = 5, alpha = 0.9) +
  annotate('text', x = -6.5, y = 14, label = 'Species Difference: *** p < 0.001', size = 4.5) +
  annotate('text', x = -9.7, y = 86.1, label = 'b', size = 12) +
...
fd.mpa.spp <- ggplot(data= fd_remef_year_df, aes(mpa.unscaled, fd_remef_year, color = Species,shape = Species)) + 
  geom_point(size = 2, alpha = .65) + 
  geom_abline(slope = -0.143, intercept = 7.077, color = "#9D0208", cex = 1, alpha = 0.9) +
  geom_abline(slope = -0.143, intercept = 4.966, color = "#F48C06", cex = 1, alpha = 0.9) +
  annotate('point', x = -5.411, y = 7.850773, color = "#9D0208", size = 5, alpha = 0.9) +
  annotate('point', x = -7.444, y = 5.963496, color = "#F48C06", size = 5, alpha = 0.9) +
...
gd.mpa.spp <- ggplot(data= gd_remef_year_df, aes(mpa.unscaled, gd_remef_year, color = Species, shape = Species)) + 
  geom_point(size = 2, alpha = .65) + 
  geom_abline(slope = -1.214, intercept = 125.726, color = "#9D0208", cex = 1, alpha = 0.9) +
  geom_abline(slope = -1.214, intercept = 124.922, color = "#F48C06", cex = 1, alpha = 0.9) +
  annotate('point', x = -5.411, y = 132.295, color = "#9D0208", size = 5, alpha = 0.9) +
  annotate('point', x = -7.444, y = 133.959, color = "#F48C06", size = 5, alpha = 0.9) +
  labs(x="Water Potential (-Mpa)", y="Glow Duration")  +
  annotate('text', x = -6.35, y = 45.726, label = 'Species Difference: non-significant', size = 4.5) +
  annotate('text', x = -9.7, y = 205, label = 'd', size = 12) +
  th +
  th_panels +
  theme(axis.text = element_text(size = 14)) +
  color_panels
...
ggsave(here("figures", 'main-figures', "Figure4.Species.Plot.jpg"),
...
pc1.lfm.mem <- ggplot(data= pc1_remef_year_df, aes(lfm.unscaled, pc1_remef_year, color = Species,shape = Species)) + 
  ...
  geom_abline(slope = -0.014, intercept = 0.629, color = "#9D0208", cex = 1) +
  geom_abline(slope = -0.014, intercept = -0.053, color = "#F48C06", cex = 1) +
  annotate('point', x = 65.67, y = -0.29038, color = "#9D0208", size = 5, alpha = 0.9) +
  annotate('point', x = 59.55, y = -0.8867, color = "#F48C06", size = 5, alpha = 0.9) +
...
tti.lfm.mem <- ggplot(data= tti_groups_ranis, aes(lfm.unscaled, r1_1, color = Species, shape = Species), xlim = c(0, 170)) + 
  geom_point(size = 1.2, alpha = .6) + 
 geom_abline(slope = 0.183, intercept = 27.984, color = "#9D0208", cex = 1) +
  geom_abline(slope = 0.183, intercept = 33.901, color = "#F48C06", cex = 1) +
  annotate('point', x = 65.67, y = 40.00161, color = "#9D0208", size = 5, alpha = 0.9) +
  annotate('point', x = 59.55, y = 44.79865, color = "#F48C06", size = 5, alpha = 0.9) +
...
fd.lfm.mem <- ggplot(data= fd_remef_year_df, aes(lfm.unscaled, fd_remef_year, color = Species,shape = Species)) + 
  geom_point(size = 1.2, alpha = .6) + 
  geom_abline(slope = -0.014, intercept = 8.772, color = "#9D0208", cex = 1) +
  geom_abline(slope = -0.014, intercept = 6.78, color = "#F48C06", cex = 1) +
  annotate('point', x = 65.67, y = 7.85262, color = "#9D0208", size = 5, alpha = 0.9) +
  annotate('point', x = 59.55, y = 5.9463, color = "#F48C06", size = 5, alpha = 0.9) +
...
gd.lfm.mem <- ggplot(data= gd_remef_year_df, aes(lfm.unscaled, gd_remef_year, color = Species,shape = Species)) + 
  geom_point(size = 1.2, alpha = .6) + 
  geom_abline(slope = -0.157, intercept = 142.348, color = "#9D0208", cex = 1) +
  geom_abline(slope = -0.157, intercept = 150.068, color = "#F48C06", cex = 1) +
  annotate('point', x = 65.67, y = 125.5943, color = "#9D0208", size = 5, alpha = 0.9) +
  annotate('point', x = 59.55, y = 134.2862, color = "#F48C06", size = 5, alpha = 0.9) +
