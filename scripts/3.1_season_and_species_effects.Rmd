...
plot.sz.mem <- cowplot::plot_grid(
       ...
       # NULL,
        pc1.vs.mpa.ceme + theme(plot.margin = unit(c(.25, 0, 0, 0), "cm")),
        pc2.vs.mpa.adfa + theme(plot.margin = unit(c(.25, 0, 0, 0), "cm")), 
      #  NULL,
        pc2.vs.mpa.ceme + theme(plot.margin = unit(c(.25, 0, 0, 0), "cm")),
        mpa.vs.lfm.adfa + theme(plot.margin = unit(c(.25, 0, 0, 0), "cm")),
      #  NULL,
        mpa.vs.lfm.ceme + theme(plot.margin = unit(c(.25, 0, 0, 0), "cm")),
        align='vh', 
        axis = 'lr',
        vjust=.5,
        rel_widths = c(1, 1),
...
plot_legend.sz.mem <- cowplot::plot_grid(legend.sz, scatterplot.sz.mem, ncol = 1, rel_heights = c(1,10))
plot_legend.sz.mem
