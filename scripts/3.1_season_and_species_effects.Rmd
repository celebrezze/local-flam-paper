...
plot.sz.mem <- cowplot::plot_grid(
        pc1.vs.mpa.adfa + theme(plot.margin = unit(c(0, 0.1, 0.25, 0), "cm")), 
        NULL,
        pc1.vs.mpa.ceme + theme(plot.margin = unit(c(0, -1, 0.25, 0.25), "cm")),
        pc2.vs.mpa.adfa + theme(plot.margin = unit(c(0, 0.1, 0.25, 0), "cm")), 
        NULL,
        pc2.vs.mpa.ceme + theme(plot.margin = unit(c(0, -1, 0.25, 0.25), "cm")),
        mpa.vs.lfm.adfa + theme(plot.margin = unit(c(0, 0.1, 0.25, 0), "cm")),
        NULL,
        mpa.vs.lfm.ceme + theme(plot.margin = unit(c(0, -1, 0.25, 0.25), "cm")),
        align='vh', 
        vjust=.5,
        rel_widths = c(1, 0, 1),
        scale = 1,
