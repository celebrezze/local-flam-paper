...
seg.data.subset <- clean.mem.data %>% 
  mutate(lfm = lfm.NAs.imputed, 
         id = individual) %>% 
 dplyr::select(id, PC1, PC2, mpa, lfm, ww.flam.sample, dw.flam.sample, spp, tti, fh, fd, gd, gti, pfg, temp.max, year.month, prop.ignite.bins10_nodate, prop.ignite.bins5_nodate, ttfg)
