...
tab_model(mpa_mod_fig.mpa, m11, m7, m10, m3, m6, m6.5, m12, m15,
  ...
  string.p = "P-Value", 
  p.style = "stars",
  file = here('figures','MEM.table.no.collinearity.html')) # saving .html into figures folder
```
...
tab_model(m1, m2, m3, m4, m5,
  ...
  string.p = "P-Value", 
  p.style = "stars",
  file = here('MEM.figures','main.model.selection.html')) # saving .html into figures folder
```
