...
### 3.0.2 Removing effects of random effects
Remeff package
...
## 3.0.4 Using Mixed Effects Models
#### Models
```{r}
...
tab_model(m.tti, m.fd, m.gd, m.pc1,
          show.reflvl = TRUE, 
          digits = 3, 
          show.aic = TRUE, 
          show.ci = FALSE,
          ...
          string.pred = "Coeffcient", 
         title = "season plot model selection",
         dv.labels = c('TTI Model', 'FD Model', 'GD Model', 'PC1 Model'),
  string.p = "P-Value", 
  p.style = "stars")
```
...
#--------
## 3.1 LFM species effects (supplemental figure)
