...
pc1.vs.lfm.adfa.site <- szn_lfm_ranis  %>%
  ...
  geom_abline(slope = -0.01, intercept = 1.795,
              color = '#669bbc', cex = 1, alpha = .9,
              show.legend = FALSE) +
  geom_abline(slope = -0.01, intercept = 1.409,
              color = '#c1121f', cex = 1, alpha = .4,
              show.legend = FALSE) +
  geom_abline(slope = -0.01, intercept = 1.994,
              color = '#669bbc', cex = 1, alpha = .4,
              show.legend = FALSE) +
  geom_segment(aes(x = 15, xend = 15, y = -5, yend = -3.4), arrow = arrow(length = unit(0.15, 'inches')), color = 'black') +
  annotate('text', x = 15, y = -2.25, label = 'More \n Combustible \n & Ignitable', fontface = 2) +
...
pc1.vs.lfm.ceme.site <- szn_lfm_ranis  %>%
  ...
  geom_abline(slope = -0.013, intercept = 1.785,
              color = '#669bbc', cex = 1, alpha = .9,
              show.legend = FALSE) +
  geom_abline(slope = -0.013, intercept = 0.55,
              color = '#c1121f', cex = 1, alpha = .4,
              show.legend = FALSE) +
  geom_abline(slope = -0.013, intercept = 1.518,
              color = '#669bbc', cex = 1, alpha = .4,
              show.legend = FALSE) +
...
pc2.vs.lfm.adfa.site <- szn_lfm_ranis  %>%
  ...
  geom_abline(slope = 0.016, intercept = -0.449,
              color = '#669bbc', cex = 1, alpha = 0.9,
              show.legend = FALSE) +
  geom_abline(slope = 0.016, intercept = -1.573,
              color = '#c1121f', cex = 1, alpha = 0.4,
              show.legend = FALSE) +
  geom_abline(slope = 0.016, intercept = -0.606,
              color = '#669bbc', cex = 1, alpha = 0.4,
              show.legend = FALSE) +
...
pc2.vs.lfm.ceme.site <- szn_lfm_ranis  %>%
  ...
  geom_abline(slope = 0.008, intercept = -0.683,
              color = '#669bbc', cex = 1, alpha = 0.9,
              show.legend = FALSE) +
  geom_abline(slope = 0.008, intercept = -1.052,
              color = '#c1121f', cex = 1, alpha = 0.4,
              show.legend = FALSE) +
  geom_abline(slope = 0.008, intercept = -0.551,
              color = '#669bbc', cex = 1, alpha = 0.4,
              show.legend = FALSE) +
...
plot_legend.sz.lfm.site <- cowplot::plot_grid(scatterplot.sz.lfm.site, legend.sz, ncol = 2, rel_widths = c(5,1))
...
tti.lfm.mem <- ggplot(data= tti_groups_ranis, aes(lfm.unscaled, r1_1, color = Species, shape = Species), xlim = c(0, 170)) + 
 ...
 geom_abline(slope = 0.183, intercept = 20.634, color = "#9D0208", cex = 1) +
  ...
  annotate('point', x = 65.67, y = 32.65161, color = "#9D0208", size = 5, alpha = 0.9) +
  annotate('point', x = 59.55, y = 37.48865, color = "#F48C06", size = 5, alpha = 0.9) +
...
fd.lfm.mem <- ggplot(data= fd_remef_year_df, aes(lfm.unscaled, fd_remef_year, color = Species,shape = Species)) + 
  ...
  annotate('point', x = 65.67, y = 8.53395, color = "#9D0208", size = 5, alpha = 0.9) +
  annotate('point', x = 59.55, y = 6.63775, color = "#F48C06", size = 5, alpha = 0.9) +
...
gd.lfm.mem <- ggplot(data= gd_remef_year_df, aes(lfm.unscaled, gd_remef_year, color = Species,shape = Species)) + 
  ...
  annotate('point', x = 65.67, y = 120.7198, color = "#9D0208", size = 5, alpha = 0.9) +
  annotate('point', x = 59.55, y = 129.4117, color = "#F48C06", size = 5, alpha = 0.9) +
...
pc1.lfm.mem <- ggplot(data= pc1_remef_year_df, aes(lfm.unscaled, pc1_remef_year, color = Species,shape = Species)) + 
  ...
  annotate('point', x = 65.67, y = 0.64162, color = "#9D0208", size = 5, alpha = 0.9) +
  annotate('point', x = 59.55, y = 0.0423, color = "#F48C06", size = 5, alpha = 0.9) +
