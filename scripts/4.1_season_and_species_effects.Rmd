...
pc1.vs.mpa.adfa.avgsite <- precip_groups_ranis  %>%
  ...
  geom_abline(slope = -0.137, intercept = 0.0965,
              color = '#c1121f', cex = 1, alpha = .7,
              show.legend = FALSE) +
  geom_abline(slope = -0.137, intercept = 0.8415,
              color = '#669bbc', cex = 1, alpha = .7,
              show.legend = FALSE) +
  labs(x = "Water Potential (-MPa)", 
       y = "Ignitability-Combustibility Proxy", 
       fill = "Season",
...
plot.sz.mem.avgsite <- cowplot::plot_grid(
        pc1.vs.mpa.adfa.avgsite + theme(plot.margin = unit(c(0.25, 0.1, 0.25, 0.25), "cm")), 
        pc1.vs.mpa.ceme.avgsite + theme(plot.margin = unit(c(0.25, 0.25, 0.25, 0.1), "cm")),
        pc2.vs.mpa.adfa.avgsite + theme(plot.margin = unit(c(0.25, 0.1, 0.25, 0.25), "cm")), 
        pc2.vs.mpa.ceme.avgsite + theme(plot.margin = unit(c(0.25, 0.25, 0.25, 0.1), "cm")),
        mpa.vs.lfm.adfa.avgsite + theme(plot.margin = unit(c(0.25, 0.1, 0.25, 0.25), "cm")),
        mpa.vs.lfm.ceme.avgsite + theme(plot.margin = unit(c(0.25, 0.25, 0.25, 0.1), "cm")),
        align='vh', vjust=.5, scale = 1,
        ncol = 2)
...
plot_legend.sz.mem.avgsite <- cowplot::plot_grid(scatterplot.sz.mem.avgsite, legend.sz, ncol = 2, rel_widths = c(5,1))
...
pc1.vs.lfm.adfa <- szn_lfm_ranis  %>%
  ...
  geom_abline(slope = -0.01, intercept = 1.795,
              color = '#669bbc', cex = 1, alpha = .9,
              show.legend = FALSE) +
  geom_segment(aes(x = 18, xend = 18, y = -5, yend = -3.4), arrow = arrow(length = unit(0.15, 'inches')), color = 'black') +
  annotate('text', x = 18, y = -2.25, label = 'More \n Combustible \n & Ignitable', fontface = 2) +
...
pc1.vs.lfm.ceme <- szn_lfm_ranis  %>%
  ...
  geom_abline(slope = -0.013, intercept = 1.785,
              color = '#669bbc', cex = 1, alpha = .9,
              show.legend = FALSE) +
  geom_segment(aes(x = 25, xend = 25, y = -5, yend = -3.4), arrow = arrow(length = unit(0.15, 'inches')), color = 'black') +
  annotate('text', x = 25, y = -2.25, label = 'More \n Combustible \n & Ignitable', fontface = 2) +
  labs(x = "Live Fuel Moisture (%)", 
       y = "Ignitability-Combustibility Proxy", 
       fill = "Season",
       color = "Season") +
...
plot.sz.lfm.site <- cowplot::plot_grid(
        ...
        pc1.vs.lfm.ceme.site + theme(plot.margin = unit(c(0.25, 0.25, 0.25, 0.25), "cm")),
        pc2.vs.lfm.adfa.site + theme(plot.margin = unit(c(0.25, 0.25, 0.25, 0.25), "cm")), 
        pc2.vs.lfm.ceme.site + theme(plot.margin = unit(c(0.25, 0.25, 0.25, 0.25), "cm")),
        align='vh', vjust=.5, scale = 1,
        ncol = 2
          )
...
pc1.mpa.mem.avgsite <- ggplot(data= pc1_remef_year_df, aes(mpa.unscaled, pc1_remef_year, color = Species,shape = Species)) + 
  geom_point(size = 2, alpha = .65) + 
  geom_abline(slope = -0.109, intercept = -0.6875, color = "#9D0208", cex = 1, alpha = 0.7) +
  geom_abline(slope = -0.109, intercept = -1.4795, color = "#F48C06", cex = 1, alpha = 0.7) +
  labs(x="Water Potential (-Mpa)", y="Ignitability-Combustibility Proxy") +
  annotate('point', x = -5.411, y = -0.097701, color = "#9D0208", size = 5, alpha = 0.7) +
  annotate('point', x = -7.444, y = -0.668104, color = "#F48C06", size = 5, alpha = 0.7) +
  annotate('text', x = -6.42, y = -4.76, label = 'Species Difference: *** p < 0.001', size = 4.5) +
  annotate('text', x = -9.7, y = 3.775, label = 'a', size = 12) +
  th +
  th_panels +
  color_panels
...
tti.mpa.mem.avgsite <- ggplot(data= tti_groups_ranis, aes(mpa.unscaled, r1_1, color = Species, shape = Species)) + 
  geom_point(size = 2, alpha = .65) + 
  geom_abline(slope = 1.381, intercept = 45.8875, color = "#9D0208", cex = 1, alpha = 0.7) +
  geom_abline(slope = 1.381, intercept = 53.277, color = "#F48C06", cex = 1, alpha = 0.7) +
  annotate('point', x = -5.411, y = 38.4149, color = "#9D0208", size = 5, alpha = 0.7) +
  annotate('point', x = -7.444, y = 42.9973, color = "#F48C06", size = 5, alpha = 0.7) +
  annotate('text', x = -6.5, y = 2, label = 'Species Difference: *** p < 0.001', size = 4.5) +
  annotate('text', x = -9.7, y = 80, label = 'b', size = 12) +
  labs(x="Water Potential (-Mpa)", y="Time to Ignition (s)")  +
  th +
...
fd.mpa.mem.avgsite <- ggplot(data= fd_remef_year_df, aes(mpa.unscaled, fd_remef_year, color = Species,shape = Species)) + 
  geom_point(size = 2, alpha = .65) + 
  geom_abline(slope = -0.133, intercept = 7.304, color = "#9D0208", cex = 1, alpha = 0.7) +
  geom_abline(slope = -0.133, intercept = 5.198, color = "#F48C06", cex = 1, alpha = 0.7) +
  annotate('point', x = -5.411, y = 8.0237, color = "#9D0208", size = 5, alpha = 0.7) +
  annotate('point', x = -7.444, y = 6.188026, color = "#F48C06", size = 5, alpha = 0.7) +
  labs(x="Water Potential (-Mpa)", y="Flame Duration (s)")  +
  annotate('text', x = -6.5, y = 0.783, label = 'Species Difference: *** p < 0.001', size = 4.5) +
  annotate('text', x = -9.7, y = 21.75, label = 'c', size = 12) +
  th +
...
gd.mpa.mem.avgsite <- ggplot(data= gd_remef_year_df, aes(mpa.unscaled, gd_remef_year, color = Species,shape = Species)) + 
  geom_point(size = 2, alpha = .65) + 
  geom_abline(slope = -1.18, intercept = 123.0485, color = "#9D0208", cex = 1, alpha = 0.7) +
  geom_abline(slope = -1.18, intercept = 129.3755, color = "#F48C06", cex = 1, alpha = 0.7) +
  annotate('point', x = -5.411, y = 129.4335, color = "#9D0208", size = 5, alpha = 0.7) +
  annotate('point', x = -7.444, y = 138.1595, color = "#F48C06", size = 5, alpha = 0.7) +
  labs(x="Water Potential (-Mpa)", y="Glow Duration (s)")  +
  scale_y_continuous(limits = c(50,235), breaks = c(50, 100, 150, 200)) +
  annotate('text', x = -6.35, y = 52, label = 'Species Difference: non-significant', size = 4.5) +
  annotate('text', x = -9.7, y = 225, label = 'd', size = 12) +
