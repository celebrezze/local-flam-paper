...
szn.diff.kable.df %>%
  ...
  save_kable(here('MEM.figures', 'MEM_SeasonDiff_kable.html'))
```
...
plot_legend.sz.mem.site <- cowplot::plot_grid(scatterplot.sz.mem.site, legend.sz, ncol = 2, rel_widths = c(5,1))
plot_legend.sz.mem.site

ggsave(here("figures", "season.plot.MEM.REMEF.site.effects.jpg"),
...
ggsave(here("figures", "season.plot.MEM.REMEF.avgsite.jpg"),
...
ggsave(here("figures", "LFM.season.plot.suppfigure.site.effect.jpg"),
...
spp.diff.kable.df <- data.frame(dep.var, col1, col2, col3, col4, col5, col6, col7, col8, col9, col10, col11, col12, col13, col14, col15, col16, col17, col18, col19, col20)
```
...
spp.diff.kable.df.long %>%
  ...
  column_spec(c(1), bold = T, border_right = T) %>% 
  column_spec(c(3), border_right = T) %>% 
  save_kable(here('MEM.figures', 'MEM_SpeciesDiff_kable.html'))
```
...
ggsave(here("figures", "species.scatterplot.MEM.site.effects.jpg"),
...
ggsave(here("figures", "species.scatterplot.MEM.avgsite.jpg"),
