...
tab_model(m1, m2, m3, m.adfa, m.ceme,
          show.reflvl = TRUE, 
          digits = 3, 
          show.aic = TRUE, 
          show.ci = FALSE,
         ...
         dv.labels = c('Model 1', 'Model 2', 'Model 3', 'Model 1 - ADFA', 'Model 1 - CEME'),
  string.p = "P-Value", 
  p.style = "stars")
...
precip_groups_ranis  %>%
  ...
  ggplot(aes(y = PC1, 
             ...
             group = season)) +
  geom_point(alpha = .5, aes(color = season)) +
  geom_abline(slope = -0.122, intercept = -1.065,
              color = '#c1121f', cex = 1,
              show.legend = FALSE) +
  geom_abline(slope = -0.122, intercept = -0.413,
              color = '#669bbc', cex = 1,
              show.legend = FALSE) +
  labs(x = "Water Potential (-MPa)", 
       y = "Ignitability-Combustibility Proxy", 
...
precip_groups_ranis  %>%
  ...
  ggplot(aes(y = PC1, 
             ...
             group = season)) +
  geom_point(alpha = .5, aes(color = season)) +
  geom_abline(slope = -0.147, intercept = -1.789,
              color = '#c1121f', cex = 1,
              show.legend = FALSE) +
  geom_abline(slope = -0.147, intercept = -1.33,
              color = '#669bbc', cex = 1,
              show.legend = FALSE) +
  labs(x = "Water Potential (-MPa)", 
       y = "Ignitability-Combustibility Proxy", 
...
precip_groups_ranis  %>%
  ...
  ggplot(aes(y = PC2, 
             ...
             group = season)) +
  geom_point(alpha = .5, aes(color = season)) +
  geom_abline(slope = 0.119, intercept = 0.159,
              color = '#c1121f', cex = 1,
              show.legend = FALSE) +
  geom_abline(slope = 0.119, intercept = 1.239,
              color = '#669bbc', cex = 1,
              show.legend = FALSE) +
  labs(x = "Water Potential (-MPa)", 
       y = "Consumability Proxy", 
...
precip_groups_ranis  %>%
  ...
  ggplot(aes(y = PC2, 
             ...
             group = season)) +
  geom_point(alpha = .5, aes(color = season)) +
  geom_abline(slope = 0.119, intercept = -0.027,
              color = '#c1121f', cex = 1,
              show.legend = FALSE) +
  geom_abline(slope = 0.119, intercept = 0.781,
              color = '#669bbc', cex = 1,
              show.legend = FALSE) +
  labs(x = "Water Potential (-MPa)", 
       y = "Consumability Proxy", 
