...
#### ADFA
```{r}
pc1.vs.lfm.adfa <- precip_groups_ranis  %>%
  filter(spp == 'ADFA') %>% 
  ggplot(aes(y = r1_1, 
             x = mpa.unscaled,
             fill = season,
             ...
             group = season)) +
  geom_point(alpha = .5, aes(color = season)) +
  geom_abline(slope = -0.122, intercept = -0.109,
              color = '#c1121f', cex = 1,
              show.legend = FALSE) +
  geom_abline(slope = -0.122, intercept = 0.587,
              color = '#669bbc', cex = 1,
              show.legend = FALSE) +
  labs(x = "Water Potential (-MPa)", 
       y = "Ignitability-Combustibility Proxy", 
...
#### CEME
```{r}
pc1.vs.lfm.ceme <- precip_groups_ranis  %>%
  filter(spp == 'CEME') %>% 
  ggplot(aes(y = r1_1, 
             x = mpa.unscaled,
             fill = season,
             ...
             group = season)) +
  geom_point(alpha = .5, aes(color = season)) +
  geom_abline(slope = -0.147, intercept = -0.834,
              color = '#c1121f', cex = 1,
              show.legend = FALSE) +
  geom_abline(slope = -0.147, intercept = -0.375,
              color = '#669bbc', cex = 1,
              show.legend = FALSE) +
  labs(x = "Water Potential (-MPa)", 
       y = "Ignitability-Combustibility Proxy", 
...
#### ADFA
```{r}
pc2.vs.lfm.adfa <- precip_groups_ranis  %>%
  filter(spp == "ADFA") %>% 
  ggplot(aes(y = r1_2, 
             x = mpa.unscaled,
             fill = season,
             ...
             group = season)) +
  geom_point(alpha = .5, aes(color = season)) +
  geom_abline(slope = 0.120, intercept = 0.144,
              color = '#c1121f', cex = 1,
              show.legend = FALSE) +
  geom_abline(slope = 0.121, intercept = 1.186,
              color = '#669bbc', cex = 1,
              show.legend = FALSE) +
  labs(x = "Water Potential (-MPa)", 
       y = "Consumability Proxy", 
...
#### CEME
```{r}
pc2.vs.lfm.ceme <- precip_groups_ranis  %>%
  filter(spp == 'CEME') %>% 
  ggplot(aes(y = r1_2, 
             x = mpa.unscaled,
             fill = season,
             ...
             group = season)) +
  geom_point(alpha = .5, aes(color = season)) +
  geom_abline(slope = 0.121, intercept = -0.032,
              color = '#c1121f', cex = 1,
              show.legend = FALSE) +
  geom_abline(slope = 0.121, intercept = 0.752,
              color = '#669bbc', cex = 1,
              show.legend = FALSE) +
  labs(x = "Water Potential (-MPa)", 
       y = "Consumability Proxy", 
...
mpa.vs.lfm.adfa <- mpa_rel_df %>% 
  ...
  ggplot(aes(y = r1_lfm, 
             ...
             group = season)) +
  geom_point(alpha = .5, aes(color = season)) +
  geom_abline(slope = 0.03, intercept = 0.01,
              color = '#c1121f', cex = 1,
              show.legend = FALSE) +
  geom_abline(slope = 0.03, intercept = 0.216,
              color = '#669bbc', cex = 1,
              show.legend = FALSE) +
  labs(x = "Water Potential (MPa)", 
...
mpa.vs.lfm.ceme <- mpa_rel_df %>% 
  ...
  ggplot(aes(y = r1_lfm, 
             ...
             group = season)) +
  geom_point(alpha = .5, aes(color = season)) +
  geom_abline(slope = 0.031, intercept = -0.037,
              color = '#c1121f', cex = 1,
              show.legend = FALSE) +
  geom_abline(slope = 0.031, intercept = 0.182,
              color = '#669bbc', cex = 1,
              show.legend = FALSE) +
  labs(x = "Water Potential (MPa)", 
       y = "Live Fuel Moisture (Scaled, Effects Removed)", 
...
plot.sz.mem <- cowplot::plot_grid(
        pc1.vs.lfm.adfa + theme(plot.margin = unit(c(0.25, 0.1, 0.25, 0.25), "cm")), 
        pc1.vs.lfm.ceme + theme(plot.margin = unit(c(0.25, 0.25, 0.25, 0.1), "cm")),
        pc2.vs.lfm.adfa + theme(plot.margin = unit(c(0.25, 0.1, 0.25, 0.25), "cm")), 
        pc2.vs.lfm.ceme + theme(plot.margin = unit(c(0.25, 0.25, 0.25, 0.1), "cm")),
...
plot_legend.sz.mem <- cowplot::plot_grid(legend.sz, scatterplot.sz.mem, ncol = 1, rel_heights = c(1,20))
plot_legend.sz.mem
...
### 3.0.3 Removing effects of random effects
Remeff package
...
## 3.0.5 Using Mixed Effects Models
#### Models
```{r}
...
tti.mpa.mem <- ggplot(data= tti_groups_ranis, aes(mpa.unscaled, r1_1, color = Species, shape = Species)) + 
  geom_point(size = 1.2, alpha = .6) + 
   geom_abline(slope = 1.381, intercept = 47.489, color = "#9D0208", cex = 1) +
  geom_abline(slope = 1.381, intercept = 54.879, color = "#F48C06", cex = 1) +
  annotate('text', x = -8, y = 12, label = 'Species Difference: *** p < 0.001', size = 3) +
  labs(x="Water Potential (-Mpa)", y="Time to Ignition (s)")  +
  th +
  th_panels +
  color_panels
...
fd.mpa.mem <- ggplot(data= fd_remef_year_df, aes(mpa.unscaled, fd_remef_year, color = Species,shape = Species)) + 
  geom_point(size = 1.2, alpha = .6) + 
  geom_abline(slope = -0.133, intercept = 7.162, color = "#9D0208", cex = 1) +
  geom_abline(slope = -0.133, intercept = 5.056, color = "#F48C06", cex = 1) +
  labs(x="Water Potential (-Mpa)", y="Flame Duration (s)")  +
  annotate('text', x = -8, y = 1, label = 'Species Difference: *** p < 0.001', size = 3) +
   th +
  th_panels +
  color_panels
fd.mpa.mem
...
gd.mpa.mem <- ggplot(data= gd_remef_year_df, aes(mpa.unscaled, gd_remef_year, color = Species,shape = Species)) + 
  geom_point(size = 1.2, alpha = .6) + 
  geom_abline(slope = -1.18, intercept = 125.59, color = "#9D0208", cex = 1) +
  geom_abline(slope = -1.18, intercept = 131.917, color = "#F48C06", cex = 1) +
  labs(x="Water Potential (-Mpa)", y="Glow Duration (s)")  +
  scale_y_continuous(limits = c(50,235), breaks = c(50, 100, 150, 200)) +
  annotate('text', x = -8, y = 55, label = 'Species Difference: insignificant', size = 3) +
   th +
  th_panels +
  color_panels
gd.mpa.mem
...
pc1.mpa.mem <- ggplot(data= pc1_remef_year_df, aes(mpa.unscaled, pc1_remef_year, color = Species,shape = Species)) + 
  geom_point(size = 1.2, alpha = .6) + 
  geom_abline(slope = -0.109, intercept = -0.882, color = "#9D0208", cex = 1) +
  geom_abline(slope = -0.109, intercept = -1.674, color = "#F48C06", cex = 1) +
  labs(x="Water Potential (-Mpa)", y="Ignitability-Combustibility Proxy") +
  annotate('text', x = -8, y = -4.55, label = 'Species Difference: *** p < 0.001', size = 3) +
  th +
  th_panels +
  color_panels
pc1.mpa.mem
