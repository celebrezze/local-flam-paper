...
main.mem.table.df %>%
  ...
  save_kable(here('figures', 'supp-figures', 'Main_MEM_Selection_kable.html'))
```
...
# Adding in MPa + WW and MPa + LFM despite their moderate collinearity to see how they affect model selection
m6 <- lmer(tti ~ mpa.scaled + ww.flam.sample + spp + site + year.month + (1 | individual), data = scaled.mem.data.alldates.noNAs)

m7 <- lmer(tti ~ mpa.scaled + lfm + sample.wt + spp + site + year.month + (1 | individual), data = scaled.mem.data.alldates.noNAs)
```
...
# Adding in MPa + WW and MPa + LFM despite their moderate collinearity to see how they affect model selection
m6 <- lmer(fh ~ mpa.scaled + ww.flam.sample + spp + site + year.month + (1 | individual), data = scaled.mem.data.alldates.noNAs)

m7 <- lmer(fh ~ mpa.scaled + lfm + sample.wt + spp + site + year.month + (1 | individual), data = scaled.mem.data.alldates.noNAs)
```
...
# Adding in MPa + WW and MPa + LFM despite their moderate collinearity to see how they affect model selection
m6 <- lmer(gd ~ mpa.scaled + ww.flam.sample + spp + site + year.month + (1 | individual), data = scaled.mem.data.alldates.noNAs)

m7 <- lmer(gd ~ mpa.scaled + lfm + sample.wt + spp + site + year.month + (1 | individual), data = scaled.mem.data.alldates.noNAs)
```
...
# Adding in MPa + WW and MPa + LFM despite their moderate collinearity to see how they affect model selection
m6 <- lmer(fd ~ mpa.scaled + ww.flam.sample + spp + site + year.month + (1 | individual), data = scaled.mem.data.alldates.noNAs)

m7 <- lmer(fd ~ mpa.scaled + lfm + sample.wt + spp + site + year.month + (1 | individual), data = scaled.mem.data.alldates.noNAs)
```
...
# Adding in MPa + WW and MPa + LFM despite their moderate collinearity to see how they affect model selection
m6 <- lmer(temp.max ~ mpa.scaled + ww.flam.sample + spp + site + year.month + (1 | individual), data = scaled.mem.data.alldates.noNAs)

m7 <- lmer(temp.max ~ mpa.scaled + lfm + sample.wt + spp + site + year.month + (1 | individual), data = scaled.mem.data.alldates.noNAs)
```
...
# Adding in MPa + WW and MPa + LFM despite their moderate collinearity to see how they affect model selection
m6 <- lmer(pfg ~ mpa.scaled + ww.flam.sample + spp + site + year.month + (1 | individual), data = scaled.mem.data.alldates.noNAs)

m7 <- lmer(pfg ~ mpa.scaled + lfm + sample.wt + spp + site + year.month + (1 | individual), data = scaled.mem.data.alldates.noNAs)
```
...
# Adding in MPa + WW and MPa + LFM despite their moderate collinearity to see how they affect model selection
m6 <- lmer(ttfg ~ mpa.scaled + ww.flam.sample + spp + site + year.month + (1 | individual), data = scaled.mem.data.alldates.noNAs)

m7 <- lmer(ttfg ~ mpa.scaled + lfm + sample.wt + spp + site + year.month + (1 | individual), data = scaled.mem.data.alldates.noNAs)
```
...
# Adding in MPa + WW and MPa + LFM despite their moderate collinearity to see how they affect model selection
m6 <- lmer(gti ~ mpa.scaled + ww.flam.sample + spp + site + year.month + (1 | individual), data = scaled.mem.data.alldates.noNAs)

m7 <- lmer(gti ~ mpa.scaled + lfm + sample.wt + spp + site + year.month + (1 | individual), data = scaled.mem.data.alldates.noNAs)
```
...
```{r}
dep.var <- c("PC1", " ", " ", " ", " ", " ", "Time to Ignition (s)", " ", " ", " ", " ", " ", "Flame Duration (s)", " ", " ", " ", " ", " ", "Glow Duration (s)", " ", " ", " ", " ", " ")
fix.fx <- c(" ", "Water Potential","Composite Model", "Wet Weight", "Dry Weight", "Live Fuel Moisture",
...
est1 <- c(" ", '-0.142***', '-0.134***', '-0.038', '0.399**','-0.296***',
          " ", '4.709***','4.889***', '4.260***', '3.126***', '-3.005***',
          " ", '-0.574**',  '0.612**', '-0.530*', '-0.491', '-0.426',
          " ", '-1.280', '3.741**','-1.834', '-2.029', '-1.122')
aic.values <- c(" ", '1668.106', '1672.325', '1672.357', '1681.577', '1687.590',
                " ", '3316.212',	'3318.910',	'3363.524',	'3385.911',	'3390.382',
                " ", '2562.408',	'2563.221',	'2564.659',	'2566.012',	'2567.067',
              	" ", '4141.659',	'4145.782',	'4151.125',	'4150.366',	'4152.267')
r2.values <- c(" ", '0.229 / 0.289',  '0.228 / 0.290', '0.228 / 0.289', '0.201 / 0.268', '0.192 / 0.258', 
               " ", '0.343 / 0.404',	'0.337 / 0.403',	'0.271 / 0.342',	'0.236 / 0.312',	'0.229 / 0.302',
               " ", '0.059 / 0.136',	'0.058 / 0.131',	'0.055 / 0.128',	'0.064 / 0.140',	'0.050 / 0.123',
               " ", '0.229 / 0.288',	'0.225 / 0.286',	'0.215 / 0.286',	'0.215 / 0.290',	'0.212 / 0.287')
d.aic <- c(" ", '0', '4.219',  '4.251', '13.471', '19.484',
           " ", '0', '2.698', '47.312', '69.699', '74.17',
           " ", '0', '0.813', '2.251', '3.604', '4.659',
           " ", '0', '4.123',  '9.466',  '8.707', '10.608')
deltaAIC <- c('\U0394 AIC')

x <- 1668.106
y <- c(1672.325, 1672.357, 1681.577, 1687.590)
y - x
