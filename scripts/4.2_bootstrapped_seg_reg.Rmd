...
Note: this chunk of code sometimes fails when a threshold is not found for one of the iterations, but eventually it runs. This issue was fixed for flam. metrics that consistently caused the for loop to fail as stated below
```{r}
for(i in 1:10){
...
Note: like above, this for loop often gets interrupted when a threshold is not found. After a few times, it should run okay
```{r}
for(i in 1:10){
