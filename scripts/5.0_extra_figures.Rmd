...
ggsave(here('figures', 'field.plots.jpg'), height = 8, width = 12)
```
...
ggsave(here('figures', 'predicted.pc1.jpg'), height = 5.5, width = 12)
```
...
col1 <- c('-3.21 +/- 0.15', '-2.77 +/- 0.18')
col2 <- c('79.93  +/- 4.74', '75.82 +/- 15.75')
...
pv.data.table.df %>%
  ...
  save_kable(here('figures', 'PVcurve.table.html'))
```