...
```{r}
m08 <- lmer(PC1 ~ mpa.scaled + ldmc + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df)

m01 <- lmer(PC1 ~ mpa.scaled + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df) #mpa.scaled

m06 <- lmer(PC1 ~ rwc + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df)

m07 <- lmer(PC1 ~ rwc + spp + site + year.month + sample.wt +  mpa.scaled + (1 | individual), REML = T, data = rwc_pv_df)

m02 <- lmer(PC1 ~ mpa.scaled + dw.flam.sample + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df) #composite

m05 <- lmer(PC1 ~ lfm + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df) #LFM
...
m07 <- lmer(tti ~ mpa.scaled + rwc + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df)

m06 <- lmer(tti ~ mpa.scaled + rwc + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df)
...
```{r}
m08 <- lmer(tti ~ mpa.scaled + ldmc + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df)

m01 <- lmer(tti ~ mpa.scaled + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df) #Mpa

m07 <- lmer(tti ~ mpa.scaled + rwc + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df)

m06 <- lmer(tti ~ mpa.scaled + rwc + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df)

m02 <- lmer(tti ~ mpa.scaled + dw.flam.sample + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df) #composite

m05 <- lmer(tti ~ lfm + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df) #LFM
```
...
```{r}
m01 <- lmer(fd ~ mpa.scaled + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df) #mpa.scaled

m02 <- lmer(fd ~ mpa.scaled + dw.flam.sample + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df) #composite

m08 <- lmer(fd ~ mpa.scaled + ldmc + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df)

m04 <- lmer(fd ~ dw.flam.sample + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df) #DW

m05 <- lmer(fd ~ lfm + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df) #LFM
```

Table
```{r}
tab_model(m01, m02, m08, m04, m05,
          show.reflvl = FALSE, 
          digits = 3, 
          show.aic = TRUE, 
          show.ci = FALSE,
...
```{r}
m01 <- lmer(gd ~ mpa + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df) #Mpa

m05 <- lmer(gd ~ lfm + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df) #LFM


m011 <- lmer(gd ~ ldmc + lfm + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df)

m08 <- lmer(gd ~ mpa + ldmc + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df)


m010 <- lmer(gd ~ ldmc + rwc + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df)

```

```{r}
tab_model(m010, m011, m08, m05, m01,
          show.reflvl = FALSE, 
          digits = 3, 
          show.aic = TRUE, 
          show.ci = FALSE,
...
mem.table.df %>%
  ...
  row_spec(c(1, 5, 9, 14), background = "#e5e5e5", bold = T, font_size = 16) %>% 
  row_spec(c(0), background = "lightgrey", bold = T, font_size = 16) %>% 
  column_spec (1:6, border_left = T, border_right = T) %>%
  row_spec(c(1,2,3,5, 6,9,10,11,12, 15, 16, 17), bold = T) %>% 
