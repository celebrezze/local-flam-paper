...
```{r}
m01 <- lmer(PC1 ~ mpa.scaled + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df) #mpa.scaled

m02 <- lmer(PC1 ~ mpa.scaled + dw.flam.sample + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df) #composite

m03 <- lmer(PC1 ~ ww.flam.sample + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df) #WW

m04 <- lmer(PC1 ~ dw.flam.sample + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df) #DW

m05 <- lmer(PC1 ~ lfm + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df) #LFM

m06 <- lmer(PC1 ~ rwc + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df)

m07 <- lmer(PC1 ~ rwc + spp + site + year.month + sample.wt +  mpa.scaled + (1 | individual), REML = F, data = rwc_pv_df)

m06 <- lmer(PC1 ~ mpa.scaled + rwc + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df)

m08 <- lmer(PC1 ~ mpa.scaled + ldmc + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df)

m09 <- lmer(PC1 ~ ldmc + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df)

m010 <- lmer(PC1 ~ ldmc + rwc + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df)
...
tab_model(m08, m01, m06, m07, m02, m05,
          show.reflvl = FALSE, 
          digits = 3, 
          show.aic = TRUE, 
          show.ci = FALSE,
  ...
  string.p = "P-Value", 
  p.style = "stars",
  file = here('figures','MEM.figures','mem2.PC1.norml.html')) # saving .html into figures folder
```

```{r}
m08_pc1 <- lmer(PC1 ~ mpa.scaled + ldmc + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df)
performance::multicollinearity(m08_pc1)

m01_pc1 <- lmer(PC1 ~ mpa.scaled + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df) #mpa.scaled
performance::multicollinearity(m01_pc1)

m06_pc1 <- lmer(PC1 ~ rwc + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df)
performance::multicollinearity(m06_pc1)

m02_pc1 <- lmer(PC1 ~ mpa.scaled + dw.flam.sample + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df) #composite
performance::multicollinearity(m02_pc1)

m05_pc1 <- lmer(PC1 ~ lfm + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df) #LFM
performance::multicollinearity(m05_pc1)

```

Table
```{r}
tab_model(m08_pc1, m01_pc1, m06_pc1, m02_pc1, m05_pc1,
          show.reflvl = FALSE, 
          digits = 3, 
          show.aic = TRUE, 
          show.ci = FALSE,
          show.icc = FALSE, 
          pred.labels = c(),
          dv.labels = c("Model 5", "Model 1", "Model 3", "Model 2", "Model 4"),
         string.pred = "Coeffcient", 
         title = "PC1",
  string.p = "P-Value", 
  p.style = "stars",
...
```{r}
m01 <- lmer(tti ~ mpa.scaled + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df) #Mpa

m02 <- lmer(tti ~ mpa.scaled + dw.flam.sample + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df) #composite

m03 <- lmer(tti ~ ww.flam.sample + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df) #WW

m04 <- lmer(tti ~ dw.flam.sample + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df) #DW

m05 <- lmer(tti ~ lfm + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df) #LFM

m06 <- lmer(tti ~ rwc + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df)

m08 <- lmer(tti ~ mpa.scaled + ldmc + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df)

m09 <- lmer(tti ~ ldmc + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df)

m010 <- lmer(tti ~ ldmc + rwc + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df)

m011 <- lmer(tti ~ ldmc + lfm + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df)

summary(m011)

model_list <- c(m01, m02, m03, m04, m05, m06, m08, m09, m010, m011)

aictab(model_list)
```
```{r}
tab_model(m08, m01, m06, m02,
          show.reflvl = FALSE, 
          digits = 3, 
          show.aic = TRUE, 
          show.ci = FALSE,
  ...
  string.p = "P-Value", 
  p.style = "stars",
  file = here('figures','MEM.figures','mem2.TTI.noreml.html')) # saving .html into figures folder
```


```{r}
m08_tti <- lmer(tti ~ mpa.scaled + ldmc + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df)

m01_tti <- lmer(tti ~ mpa.scaled + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df) #Mpa

m06_tti <- lmer(tti ~ mpa.scaled + rwc + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df)

m02_tti <- lmer(tti ~ mpa.scaled + dw.flam.sample + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df) #composite

m05_tti <- lmer(tti ~ lfm + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df) #LFM
```

Table
```{r}
tab_model(m08_tti, m01_tti, m06_tti, m02_tti, m05_tti,
          show.reflvl = FALSE, 
          digits = 3, 
          show.aic = TRUE, 
          show.ci = FALSE,
...
```{r}
m01 <- lmer(fd ~ mpa.scaled + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df) #mpa.scaled

m02 <- lmer(fd ~ mpa.scaled + dw.flam.sample + spp + site +  sample.wt + (1 | individual), REML = F, data = rwc_pv_df) #composite, multicollinear?

performance::multicollinearity(m02)
```


```{r}
m03 <- lmer(fd ~ ww.flam.sample + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df) #WW

m04 <- lmer(fd ~ dw.flam.sample + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df) #DW

m05 <- lmer(fd ~ lfm + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df) #LFM

m06 <- lmer(fd ~ rwc + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df)

m07 <- lmer(fd ~ mpa.scaled + rwc + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df)

m08 <- lmer(fd ~ mpa.scaled + ldmc + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df)

m09 <- lmer(fd ~ ldmc + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df)

m010 <- lmer(fd ~ ldmc + rwc + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df)

m011 <- lmer(fd ~ ldmc + lfm + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df)
...
```{r}
tab_model(m01, m02, m08, m04, m07, m03, m05, m06, m011, m010,
          show.reflvl = FALSE, 
          digits = 3, 
          show.aic = TRUE, 
          show.ci = FALSE,
  ...
  string.p = "P-Value", 
  p.style = "stars",
  file = here('figures','MEM.figures','mem2.FD.remlF.html'))
```

```{r}
m01_fd <- lmer(fd ~ mpa.scaled + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df) #mpa.scaled

m02_fd <- lmer(fd ~ mpa.scaled + dw.flam.sample + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df) #composite

m08_fd <- lmer(fd ~ mpa.scaled + ldmc + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df)

m04_fd <- lmer(fd ~ dw.flam.sample + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df) #DW

m05_fd <- lmer(fd ~ lfm + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df) #LFM
```

Table
```{r}
tab_model(m01_fd, m02_fd, m08_fd, m04_fd, m05_fd,
          show.reflvl = FALSE, 
          digits = 3, 
          show.aic = TRUE, 
          show.ci = FALSE,
...
```{r}
m01 <- lmer(gd ~ mpa + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df) #Mpa

m02 <- lmer(gd ~ mpa + dw.flam.sample + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df) #composite

m03 <- lmer(gd ~ ww.flam.sample + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df) #WW

m04 <- lmer(gd ~ dw.flam.sample + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df) #DW

m05 <- lmer(gd ~ lfm + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df) #LFM

m06 <- lmer(gd ~ rwc + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df)

m07 <- lmer(gd ~ mpa + rwc + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df)

m08 <- lmer(gd ~ mpa + ldmc + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df)

m09 <- lmer(gd ~ ldmc + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df)

m010 <- lmer(gd ~ ldmc + rwc + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df)

m011 <- lmer(gd ~ ldmc + lfm + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df)
...
Table
```{r}
tab_model(m08, m04, m010, m03, m09, m01, m011, m05, m06,
          show.reflvl = FALSE, 
          digits = 3, 
          show.aic = TRUE, 
          show.ci = FALSE,
         ...
         # dv.labels = c("Model 5", "Model 1", "Model 3", "Model 2", "Model 4", "Model 6", "Model 7"),
         string.pred = "Coeffcient", 
         title = "Flame Duration",
  string.p = "P-Value", 
  p.style = "stars",
  file = here('figures','MEM.figures','mem2.GD.noreml.html')) # saving .html into figures folder
```

```{r}
m01_gd <- lmer(gd ~ mpa + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df) #Mpa

m05_gd  <- lmer(gd ~ lfm + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df) #LFM


m011_gd  <- lmer(gd ~ ldmc + lfm + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df)

m08_gd  <- lmer(gd ~ mpa + ldmc + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df)


m010_gd  <- lmer(gd ~ ldmc + rwc + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df)

```

```{r}
tab_model(m010_gd , m011_gd , m08_gd , m05_gd , m01_gd ,
          show.reflvl = FALSE, 
          digits = 3, 
          show.aic = TRUE, 
          show.ci = FALSE,
...
```{r}
tab_model(m08_tti, m01_tti, m06_tti, m02_tti,m05_tti,
          m08_pc1, m01_pc1, m06_pc1, m02_pc1, m05_pc1,
          m01_fd, m02_fd, m08_fd, m04_fd, m05_fd,
          m010_gd , m011_gd , m08_gd, m01_gd,  m05_gd,
          show.reflvl = FALSE, 
          digits = 3, 
          show.aic = TRUE, 
          show.ci = FALSE,
         ...
         # dv.labels = c("Model 5", "Model 1", "Model 3", "Model 2", "Model 4", "Model 6", "Model 7"),
         string.pred = "Coeffcient", 
         title = "All Top Models",
  string.p = "P-Value", 
  p.style = "stars",
  file = here('figures','MEM.figures','mem2.ALL.html'))
```
...
fix.fx <- c(
  ...
  "Water Potential",
  "LFM",
#  "Water Potential + Dry Weight",  #DONE
  " ", #TTI ---------------
  "Water Potential + LDMC",
  "Water Potential",
  "LFM",
...
mem.table.df <- data.frame(dep.var, fix.fx, est1, est2, d.aic, #aic.values,
                           r2.values)

mem.table.df %>%
  mutate(
    dep.var = cell_spec(dep.var, 'html', color = 'black', bold = T),
    fix.fx = cell_spec(fix.fx, 'html', color = 'black'),
    est1 = cell_spec(est1, 'html', color = 'black'),
    est2 = cell_spec(est2, 'html', color = 'black'),
    d.aic = cell_spec(d.aic, 'html', color = 'black'),
   # aic.values = cell_spec(aic.values, 'html', color = 'black'),
    r2.values = cell_spec(r2.values, 'html', color = 'black'
    )) %>% 
  kable(format = 'html', escape = F, col.names = c(
    'Dependent Variable',
    'Model Fixed Effects',
    'Hydration',
    "Dry Matter",
...
local_pv_curves %>% 
  #filter(year != 2016)%>% 
  ggplot(aes(y = ldmc, x = tlp, color = as.factor(date), shape = spp)) +
  geom_point() +
 # facet_wrap(~spp)+
  geom_smooth(method = "lm")
```
