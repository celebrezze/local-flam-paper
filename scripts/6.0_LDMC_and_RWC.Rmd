...
performance::multicollinearity(m08)
...
Table
```{r}
tab_model(m08_pc1, m01_pc1, m06_pc1, m05_pc1,
          show.reflvl = FALSE, 
          digits = 3, 
          show.aic = TRUE, 
          show.ci = FALSE,
...
m06_tti <- lmer(tti ~ rwc + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df)
...
Table
```{r}
tab_model(m08_tti, m01_tti, m06_tti, m05_tti,
          show.reflvl = FALSE, 
          digits = 3, 
          show.aic = TRUE, 
          show.ci = FALSE,
...
m02 <- lmer(fd ~ mpa.scaled + dw.flam.sample + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df) #composite, multicollinear?
...
m06_fd <- lmer(fd ~ rwc + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df) #LFM
```

Table
```{r}
tab_model(m01_fd, m02_fd, m08_fd, m04_fd, m05_fd, m06_fd,
          show.reflvl = FALSE, 
          digits = 3, 
          show.aic = TRUE, 
          show.ci = FALSE,
...
```{r}
m01 <- lmer(gd ~ mpa.scaled + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df) #Mpa

m02 <- lmer(gd ~ mpa.scaled + dw.flam.sample + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df) #composite
...
m07 <- lmer(gd ~ mpa.scaled + rwc + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df)

m08 <- lmer(gd ~ mpa.scaled + ldmc + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df)
...
model_list <- c(m01, m02, m03, m04, m05, m06, m07, m08, m010)
...
Table
```{r}
tab_model(m08, m04, m010, m03, m01, m05, m06,
          show.reflvl = FALSE, 
          digits = 3, 
          show.aic = TRUE, 
          show.ci = FALSE,
...
```{r}
m01_gd <- lmer(gd ~ mpa.scaled + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df) #Mpa

m05_gd  <- lmer(gd ~ lfm + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df) #LFM

m011_gd  <- lmer(gd ~ ldmc + rwc + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df)

m08_gd  <- lmer(gd ~ mpa.scaled  + ldmc + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df)

m010_gd  <- lmer(gd ~ ldmc + rwc + spp + site + year.month + sample.wt + (1 | individual), REML = T, data = rwc_pv_df)

m06_gd <- lmer(gd ~ rwc + spp + site + year.month + sample.wt + (1 | individual), REML = F, data = rwc_pv_df)

```

```{r}
tab_model(m010_gd , m011_gd , m08_gd , m05_gd , m01_gd , m06_gd,
          show.reflvl = FALSE, 
          digits = 3, 
          show.aic = TRUE, 
          show.ci = FALSE,
...
```{r}
tab_model(m08_pc1, m01_pc1, m06_pc1, m05_pc1,
          m08_tti, m01_tti, m06_tti, m05_tti,
          m08_fd, m01_fd, m06_fd, m05_fd, m04_fd, m02_fd, 
          m08_gd, m01_gd, m06_gd, m05_gd, m010_gd,
          show.reflvl = FALSE, 
          digits = 3, 
          show.aic = FALSE, 
         # show.aicc = TRUE,
  ...
  string.p = "P-Value", 
  p.style = "stars",
  file = here('figures','supp-figures','FEBovingST10.html'))
```
...
mem.table.df %>%
  ...
  row_spec(c(1, 6, 11, 18), background = "#e5e5e5", bold = T, font_size = 16) %>% 
  row_spec(c(0), background = "lightgrey", bold = T, font_size = 16) %>% 
  column_spec (1:6, border_left = T, border_right = T) %>%
  row_spec(c(1,2, 3, 6,7,11, 12, 13, 14, 15, 18, 19, 20), bold = T) %>% 
  kableExtra::save_kable(here('figures', 'extra-figures', 'expanded_MEM_kable2.html'))
```
