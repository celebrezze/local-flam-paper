...
tab_model(a.p1, a.p5, a.p3, a.p2, a.p4, c.p1, c.p3, c.p4, c.p5, c.p2,
  ...
  string.p = "P-Value", 
  p.style = "stars",
  file = here('MEM.figures','PC1.by.species.html')) # saving .html into figures folder
```
...
tab_model(a.t5, a.t1, a.t3, a.t2, a.t4, c.t5, c.t1, c.t3, c.t4, c.t2,
  ...
  string.p = "P-Value", 
  p.style = "stars",
  file = here('MEM.figures','TTI.by.species.html')) # saving .html into figures folder
```
...
tab_model(a.f1, a.f4, a.f2, a.f3, a.f5, c.f4, c.f2, c.f1, c.f3, c.f5,
  ...
  string.p = "P-Value", 
  p.style = "stars",
  file = here('MEM.figures','FD.by.species.html')) # saving .html into figures folder
```
...
tab_model(a.g5, a.g4, a.g2, a.g3, a.g1, c.g5, c.g4, c.g1, c.g2, c.g3,
  ...
  string.p = "P-Value", 
  p.style = "stars",
  file = here('MEM.figures','GD.by.species.html')) # saving .html into figures folder
```
...
mem.spp.table.df <- data.frame(dep.var, sp.lab, fix.fx, est, d.aic, aic.values, bic.values, r2.values)
```

```{r}
mem.spp.table.df %>%
  kable(format = 'html', escape = F, col.names = c('Dependent Variable', 'Species', 'Model Fixed Effects', 'Water Estimate','Change in AIC', 'AIC', 'BIC', expression('Marginal R2/Conditional R2'))) %>% 
  ...
  save_kable(here('figures', 'Supp_Species_Split_MEM_kable.html'))
```
...
```{r}
dep.var <- c("PC1", " ", " ", " ", " ", "Time to Ignition (s)", " ", " ", " ", " ", "Flame Duration (s)", " ", " ", " ", " ", "Glow Duration (s)", " ", " ", " ", " ")
dep.varb <- c(" ","PC1", " ", " ", " ", " ", " ", "Time to Ignition (s)", " ", " ", " ", " ", " ", "Flame Duration (s)", " ", " ", " ", " ", " ", "Glow Duration (s)", " ", " ", " ", " ")
fix.fx <- c("Water Potential","Composite Model", "Wet Weight", "LFM", "Dry Weight",
            "Composite Model", "Water Potential",  "Wet Weight", "LFM", "Dry Weight",
            "Water Potential",  "Dry Weight", "LFM",  "Composite Model", "Wet Weight",
             "Composite Model", "Dry Weight", "LFM", "Water Potential", "Wet Weight")
...
shmoo <- data.frame(dep.varb, d.aic)
mem.table.df %>%
  ...
  kable(format = 'html', escape = F, col.names = c('Dependent Variable', 'Model Fixed Effects', 'Water Estimate','Change in AIC', 'AIC', 'BIC', expression('Marginal R2/Conditional R2'))) %>% 
  kable_styling(bootstrap_options = c('hover', 'bordered', 'condensed'), fixed_thead = T) %>% 
  row_spec(c(1, 6, 11, 16), background = "#D3D3D3", bold = T) %>% 
  save_kable(here('figures', 'expanded_MEM_kable.html'))

shmoo %>%
  kable(format = 'html', escape = F, col.names = c('Dependent Variable','Change in AIC')) %>% 
  kable_styling(bootstrap_options = c('hover', 'bordered', 'condensed'), fixed_thead = T) %>% 
  row_spec(c(1, 6, 11, 16), background = "#D3D3D3", bold = T)
```
