...
```{r}
dep.var <- c("PC1", " ", " ", " ", " ", "Time to Ignition (s)", " ", " ", " ", " ", "Flame Duration (s)", " ", " ", " ", " ", "Glow Duration (s)", " ", " ", " ", " ")
fix.fx <- c("Water Potential","Water Potential, Sample Weight & Dry Weight", "Wet Weight", "LFM", "Dry Weight",
            "Water Potential, Sample Weight & Dry Weight", "Water Potential",  "Wet Weight", "LFM", "Dry Weight",
            "Water Potential",  "Dry Weight", "LFM",  "Water Potential, Sample Weight & Dry Weight", "Wet Weight",
             "Water Potential, Sample Weight & Dry Weight", "Dry Weight", "LFM", "Water Potential", "Wet Weight")
...
mem.table.df %>%
  ...
  kable_styling(bootstrap_options = c('hover', 'bordered', 'condensed'), fixed_thead = T) %>% 
  row_spec(c(1, 6, 11, 16), background = "#D3D3D3") %>% 
