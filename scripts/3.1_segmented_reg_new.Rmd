...
fit[complete.cases(rowSums(cbind(seg.ceme.subset$gti, seg.ceme.subset.gti$lfm)))] <- broken.line(segmented.mod)$fit
...
Making dataframe
```{r}
lfm.thresholds <- c(109.32, NA, 131.08, 71.523, 83.981, 85.741, 30.825, 98.265, 30.825, 96.118, NA, 84.143, 79.555, NA, 119.38, NA, NA, NA, NA, NA, 79.555, NA, 56.968, 74.711, NA, 106.85, NA, NA)

spp.thresholds <- c("ADFA", "ADFA (limited)", "CEME", "CEME (limited)", "ADFA", "ADFA (limited)", "CEME", "CEME (limited)", "ADFA", "ADFA (limited)", "CEME", "CEME (limited)", "ADFA", "ADFA (limited)", "CEME", "CEME (limited)",  "ADFA", "ADFA (limited)", "CEME", "CEME (limited)","ADFA", "ADFA (limited)", "CEME", "CEME (limited)",  "ADFA", "ADFA (limited)", "CEME", "CEME (limited)")

metrics.thresholds <- c(rep("PC1", 4), rep("prop.ignite.10", 4), rep("prop.ignite.5", 4), rep("TTI", 4), rep("FD", 4), rep("FH", 4), rep("GD", 4))
...
threshold.df %>% 
  ...
  ggplot(aes(x = metric, y = threshold)) +
    ...
    annotate("text", x = 6, y = 140, label = "n = 2") +
