...
```{r}
jpeg(here('figures', 'seg.reg.rand.plot.v2.jpg'), width = 1200, height = 900, res = 100)
par(mfrow = c(2,2))
par(font.lab = 2)
...
mtext("C. megacarpus", font = 3, cex = 1.5, side = 3, line = 1, at = 160)
...
mtext("A. fasciculatum", font = 3, cex = 1.5, side = 3, line = 1, at = 78)
...
mtext("a", font = 2, cex = 2, side = 3, line = 1, at = 0)
mtext("C. megacarpus", font = 3, cex = 1.3, side = 3, line = 1, at = 140)
#####################################################
rsegplot.lfm.nolegend(os.mod.a1, seg.ceme.s20.subset, 'CEME', y.variable = 'PC1',y.lab = "Ignitability-Combustibility Proxy", tlp = mean_lfm_ceme, tlp.lower = lwr_lfm_ceme, tlp.upper = upr_lfm_ceme)
segments(x0 = p.1, x1 = max.lfm.c, y0 = m2.1*((b.1 - b2.1)/(m2.1 - m.1))+b2.1 , y1 = m2.1*max.lfm.c + b2.1, lwd = 4, col = "#9D0208")
mtext("b", font = 2, cex = 2, side = 3, line = 1, at = 0)
mtext("September 2020", font = 1, cex = 1, side = 3, line = 1, at = 115)
#####################################################
rsegplot.lfm.nolegend(os.mod.a2, seg.ceme.d19.subset, 'CEME', y.variable = 'PC1',y.lab = "Ignitability-Combustibility Proxy", tlp = mean_lfm_ceme, tlp.lower = lwr_lfm_ceme, tlp.upper = upr_lfm_ceme)
segments(x0 = p.2, x1 = max.lfm.c, y0 = m2.2*((b.2 - b2.2)/(m2.2 - m.2))+b2.2 , y1 = m2.2*max.lfm.c + b2.2, lwd = 4, col = "#9D0208")
mtext("c", font = 2, cex = 2, side = 3, line = 1, at = 0)
mtext("December 2019", font = 1, cex = 1, side = 3, line = 1, at = 115)
#####################################################
rsegplot.lfm(os.mod.b, seg.ceme.subset, 'CEME', y.variable = 'tti',y.lab = "Time to Ignition (s)", tlp = mean_lfm_ceme, tlp.lower = lwr_lfm_ceme, tlp.upper = upr_lfm_ceme)
mtext("d", font = 2, cex = 2, side = 3, line = 1, at = 0)
#####################################################
rsegplot.lfm.nolegend(os.mod.b1, seg.ceme.s20.subset, 'CEME', y.variable = 'tti',y.lab = "Time to Ignition (s)", tlp = mean_lfm_ceme, tlp.lower = lwr_lfm_ceme, tlp.upper = upr_lfm_ceme)
segments(x0 = p.3, x1 = max.lfm.c, y0 = m2.3*((b.3 - b2.3)/(m2.3 - m.3))+b2.3 , y1 = m2.3*max.lfm.c + b2.3, lwd = 4, col = "#9D0208")
mtext("e", font = 2, cex = 2, side = 3, line = 1, at = 0)
#####################################################
rsegplot.lfm.nolegend(os.mod.b2, seg.ceme.d19.subset, 'CEME', y.variable = 'tti',y.lab = "Time to Ignition (s)", tlp = mean_lfm_ceme, tlp.lower = lwr_lfm_ceme, tlp.upper = upr_lfm_ceme)
segments(x0 = p.4, x1 = max.lfm.c, y0 = m2.4*((b.4 - b2.4)/(m2.4 - m.4))+b2.4 , y1 = m2.4*max.lfm.c + b2.4, lwd = 4, col = "#9D0208")
mtext("f", font = 2, cex = 2, side = 3, line = 1, at = 0)
#####################################################
rsegplot.lfm(os.mod.c, seg.adfa.subset, 'ADFA', y.variable = 'PC1',y.lab = "Ignitability-Combustibility Proxy", tlp = mean_lfm_adfa, tlp.lower = lwr_lfm_adfa, tlp.upper = upr_lfm_adfa, max.x = max.lfm.a)
arrows(x0 = 10, x1 = 10, y0 = -4.8, y1 = -3.55, length = 0.1, lwd = 1.3)
text(x = 10, y = -2.65, labels = c("More \n Combustible \n & Ignitable"), cex = 0.8)
mtext("g", font = 2, cex = 2, side = 3, line = 1, at = 0)
mtext("A. fasciculatum", font = 3, cex = 1.3, side = 3, line = 1, at = 70)
#####################################################
rsegplot.lfm.nolegend(os.mod.c1, seg.adfa.s20.subset, 'ADFA', y.variable = 'PC1',y.lab = "Ignitability-Combustibility Proxy", tlp = mean_lfm_adfa, tlp.lower = lwr_lfm_adfa, tlp.upper = upr_lfm_adfa, max.x = max.lfm.a)
mtext("September 2020", font = 1, cex = 1, side = 3, line = 1, at = 55)
mtext("h", font = 2, cex = 2, side = 3, line = 1, at = 0)
#####################################################
rsegplot.lfm.nolegend(os.mod.c2, seg.adfa.d16.subset, 'ADFA', y.variable = 'PC1',y.lab = "Ignitability-Combustibility Proxy", tlp = mean_lfm_adfa, tlp.lower = lwr_lfm_adfa, tlp.upper = upr_lfm_adfa, max.x = max.lfm.a)
mtext("December 2016", font = 1, cex = 1, side = 3, line = 1, at = 55)
mtext("i", font = 2, cex = 2, side = 3, line = 1, at = 0)
#####################################################
rsegplot.lfm(os.mod.d, seg.adfa.subset, 'ADFA', y.variable = 'tti',y.lab = "Time to Ignition (s)", tlp = mean_lfm_adfa, tlp.lower = lwr_lfm_adfa, tlp.upper = upr_lfm_adfa, max.x = max.lfm.a)
mtext("j", font = 2, cex = 2, side = 3, line = 1, at = 0)
#####################################################
rsegplot.lfm.nolegend(os.mod.d1, seg.adfa.s20.subset, 'ADFA', y.variable = 'tti',y.lab = "Time to Ignition (s)", tlp = mean_lfm_adfa, tlp.lower = lwr_lfm_adfa, tlp.upper = upr_lfm_adfa, max.x = max.lfm.a)
mtext("k", font = 2, cex = 2, side = 3, line = 1, at = 0)
#####################################################
rsegplot.lfm.nolegend(os.mod.d2, seg.adfa.d16.subset, 'ADFA', y.variable = 'tti',y.lab = "Time to Ignition (s)", tlp = mean_lfm_adfa, tlp.lower = lwr_lfm_adfa, tlp.upper = upr_lfm_adfa, max.x = max.lfm.a)
mtext("l", font = 2, cex = 2, side = 3, line = 1, at = 0)
#####################################################
dev.off()
```
