...
## ADFA
```{r}
out.lm<-lm(prop.ignite.bins10_nodate ~ mpa, data = seg.adfa.subset.limited)
davies.test(out.lm, k = 50)
# Highly significant (p < 0.0005)
...
fit[complete.cases(rowSums(cbind(seg.adfa.subset.limited$prop.ignite.bins5_nodate, seg.adfa.subset.limited$mpa)))] <- broken.line(segmented.mod)$fit
...
segplot(seg.adfa.subset.limited, mpa, prop.ignite.bins5_nodate, fit, mean_mpa_ceme, lwr_mpa_ceme, upr_mpa_ceme, lower, upper)
```

## CEME
```{r}
out.lm<-lm(prop.ignite.bins10_nodate ~ mpa, data = seg.ceme.subset.limited)
davies.test(out.lm, k = 50)
# Highly significant (p < 0.00005)
...
fit[complete.cases(rowSums(cbind(seg.ceme.subset.limited$prop.ignite.bins10_nodate, seg.ceme.subset.limited$mpa)))] <- broken.line(segmented.mod)$fit

segplot(seg.ceme.subset.limited, mpa, prop.ignite.bins10_nodate, fit, mean_mpa_ceme, lwr_mpa_ceme, upr_mpa_ceme, lower, upper)
```
...
## ADFA
```{r}
out.lm<-lm(gd ~ mpa, data = seg.adfa.subset.limited)
davies.test(out.lm, k = 50)
# Result: significant (p = 0.02653)
...
fit[complete.cases(rowSums(cbind(seg.adfa.subset.limited$gd, seg.adfa.subset.limited$mpa)))] <- broken.line(segmented.mod)$fit

segplot(seg.adfa.subset.limited, mpa, gd, fit, mean_mpa_adfa, lwr_mpa_adfa, upr_mpa_adfa, lower, upper)
```
...
## ADFA
```{r}
out.lm<-lm(gti ~ mpa, data = seg.adfa.subset.limited)
davies.test(out.lm, k = 50)
# Result: insignificant
...
fit[complete.cases(rowSums(cbind(seg.adfa.subset.limited$gti, seg.adfa.subset.limited$mpa)))] <- broken.line(segmented.mod)$fit

segplot(seg.adfa.subset.limited, mpa, gti, fit, mean_mpa_adfa, lwr_mpa_adfa, upr_mpa_adfa, lower, upper)
```

## CEME
```{r}
out.lm<-lm(gti ~ mpa, data = seg.ceme.subset.limited)
davies.test(out.lm, k = 50)
# Result: insignificant 
...
fit[complete.cases(rowSums(cbind(seg.ceme.subset.limited$gti, seg.ceme.subset.limited$mpa)))] <- broken.line(segmented.mod)$fit

segplot(seg.ceme.subset.limited, mpa, gti, fit, mean_mpa_ceme, lwr_mpa_ceme, upr_mpa_ceme, lower, upper)
...
## ADFA
```{r}
out.lm<-lm(pfg ~ mpa, data = seg.adfa.subset.limited)
davies.test(out.lm, k = 50)
# Result: insignificant
...
fit[complete.cases(rowSums(cbind(seg.adfa.subset.limited$pfg, seg.adfa.subset.limited$mpa)))] <- broken.line(segmented.mod)$fit

segplot(seg.adfa.subset.limited, mpa, pfg, fit, mean_mpa_adfa, lwr_mpa_adfa, upr_mpa_adfa, lower, upper)
```

## CEME 
```{r}
out.lm<-lm(pfg ~ mpa, data = seg.ceme.subset.limited)
davies.test(out.lm, k = 50)
# Result: insignificant 
...
fit[complete.cases(rowSums(cbind(seg.ceme.subset.limited$pfg, seg.ceme.subset.limited$mpa)))] <- broken.line(segmented.mod)$fit

segplot(seg.ceme.subset.limited, mpa, pfg, fit, mean_mpa_ceme, lwr_mpa_ceme, upr_mpa_ceme, lower, upper)
...
## ADFA
```{r}
out.lm<-lm(temp.max ~ mpa, data = seg.adfa.subset.limited)
davies.test(out.lm, k = 50)
# Result: insignificant
...
fit[complete.cases(rowSums(cbind(seg.adfa.subset.limited$temp.max, seg.adfa.subset.limited$mpa)))] <- broken.line(segmented.mod)$fit

segplot(seg.adfa.subset.limited, mpa, temp.max, fit, mean_mpa_adfa, lwr_mpa_adfa, upr_mpa_adfa, lower, upper)
```

## CEME
```{r}
out.lm<-lm(temp.max ~ mpa, data = seg.ceme.subset.limited)
davies.test(out.lm, k = 50)
# Result: insignificant 
...
fit[complete.cases(rowSums(cbind(seg.ceme.subset.limited$temp.max, seg.ceme.subset.limited$mpa)))] <- broken.line(segmented.mod)$fit

segplot(seg.ceme.subset.limited, mpa, temp.max, fit, mean_mpa_ceme, lwr_mpa_ceme, upr_mpa_ceme, lower, upper)
```
...
```{r}
out.lm<-lm(ttfg ~ mpa, data = seg.adfa.subset.limited)
davies.test(out.lm, k = 50)
# Result: insignificant
...
fit[complete.cases(rowSums(cbind(seg.adfa.subset.limited$ttfg, seg.adfa.subset.limited$mpa)))] <- broken.line(segmented.mod)$fit

segplot(seg.adfa.subset.limited, mpa, ttfg, fit, mean_mpa_adfa, lwr_mpa_adfa, upr_mpa_adfa, lower, upper)
```

## CEME
```{r}
out.lm<-lm(ttfg ~ mpa, data = seg.ceme.subset.limited)
davies.test(out.lm, k = 50)
# Result: insignificant 
...
fit[complete.cases(rowSums(cbind(seg.ceme.subset.limited$ttfg, seg.ceme.subset.limited$mpa)))] <- broken.line(segmented.mod)$fit

segplot(seg.ceme.subset.limited, mpa, ttfg, fit, mean_mpa_ceme, lwr_mpa_ceme, upr_mpa_ceme, lower, upper)
```