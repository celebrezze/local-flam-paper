...
o<-lme(prop.ignite.bins10_nodate ~ lfm, random=list(id=pdDiag(~1+lfm)), 
       data = seg.ceme.subset.limited)

##oseg<-segmented.lme(o, Z=lfm, random=list(id=pdDiag(~1+lfm+U)))
...
```{r}
#with random changepoints: 
o<-lme(prop.ignite.bins5_nodate ~ lfm, random=list(id=pdDiag(~1+lfm)), 
